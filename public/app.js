...
const QUEST_IMG_BASE = {
  ...
  'sharon': { base: '/img/quests/sharon/', count: 54 },
  'dark-emilia': { base: '/img/quests/dark-emilia/', count: 26 },
  'nar-2': { base: '/img/quests/nar-2/', count: 27 },
  'mboma-ll': { base: '/img/quests/mboma-ll/', count: 30 },
  'jose-cortasar': { base: '/img/quests/jose-cortasar/', count: 13 },
  'gurtrude': { base: '/img/quests/gurtrude/', count: 20 },
  'gracielo': { base: '/img/quests/gracielo/', count: 39 },
  'selva': { base: '/img/quests/selva/', count: 41 },
  'irawan': { base: '/img/quests/irawan/', count: 13 },
  'ania': { base: '/img/quests/ania/', count: 27 },
  'vincent': { base: '/img/quests/vincent/', count: 22 },
  'soso': { base: '/img/quests/soso/', count: 18 },
  'marie': { base: '/img/quests/marie/', count: 67 },
